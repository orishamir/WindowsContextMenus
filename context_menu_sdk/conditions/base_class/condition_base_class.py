...
from context_menu_sdk.conditions.base_class.condition_meta import ConditionMeta
from context_menu_sdk.conditions.base_class.icondition import ICondition
