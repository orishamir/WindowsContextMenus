...
from context_menu_sdk.configuration.models import ContextMenuConfig, ConditionsConfig
from context_menu_sdk.configuration.comparers import (
...
from context_menu_sdk.comparers import (
    IComparer,
    StartsWith,
    Contains,
    Equal,
...
from context_menu_sdk.conditions import (
    FileName,
    ICondition,
    And,
    FileSize,
