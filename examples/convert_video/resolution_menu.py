...
from context_menu_toolkit.context_menu_locations import ContextMenuBinding, MenuAccessScope, MenuItemType
...
for resolution in (Resolution.HD, Resolution.FHD):
    resolution_submenus.append(
        ContextMenu(
            ...
            [
                EntryName(f"Convert to {resolution}"),
                Command(
                    BASE_COMMAND.format(
